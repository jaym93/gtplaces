...
#define CONFIGURE_COMMAND " './configure'  '--disable-xml' '--disable-dom' '--disable-libxml' '--disable-simplexml' '--without-pear' '--disable-xmlreader' '--disable-xmlwriter' '--without-iconv' '--with-openssl-dir=/usr/local/openssl-0.9.8l'"
